...
- Smoke scene SRP fallback and ScenarioURP assets were deleted, changing background/visual behavior.
- Render catalog references moved from scene-authored assets to Resources assets without explicit parity checks.
