...
- Add `AlignmentTriplet`, `RaceId`, `CultureId`, `DynamicBuffer<EthicAxisValue>`, `DynamicBuffer<OutlookEntry>` to crew prefabs.
- Maintain aggregated buffers on crews/fleets/colonies/factions: `DynamicBuffer<TopOutlook>`, `RacePresence`, `CulturePresence`.
...
## Authoring & Tooling
- Enum registry for `EthicAxisId`, `OutlookId`, `AffiliationType` shared across authoring/narrative/DOTS code.
