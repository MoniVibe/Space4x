...
- Rendering: use Space4X render catalog pipeline (`Assets/Data/Space4XRenderCatalog.asset` + `ApplyRenderCatalogSystem`), align with `Docs/Rendering/Space4X_RenderKey_TruthSource.md`.
