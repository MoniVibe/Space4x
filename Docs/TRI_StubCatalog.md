...
- **File**: `Assets/Scripts/Space4x/Stubs/Space4XServiceBridges.cs`
  - **Module**: Game-side bridges into PureDOTS services (nav, combat, economy, diplomacy, telemetry, sensors, time, narrative, persistence).
  - **Types**: `Space4XNavigationBridgeStub`, `Space4XCombatBridgeStub`, `Space4XEconomyBridgeStub`, `Space4XDiplomacyBridgeStub`, `Space4XTelemetryBridgeStub`, `Space4XSensorBridgeStub`, `Space4XTimeBridgeStub`, `Space4XNarrativeBridgeStub`, `Space4XSaveLoadBridgeStub`.
