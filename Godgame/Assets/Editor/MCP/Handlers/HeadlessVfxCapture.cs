    ...
    public static class HeadlessVfxCapture
    {
        ...
        public static void RunFromCommandLine()
        {
            try
            {
                ...
                {
                    graphPath = global::System.Environment.GetEnvironmentVariable("VFX_GRAPH_PATH");
                    graphId = global::System.Environment.GetEnvironmentVariable("VFX_GRAPH_ID");
                }
                if (string.IsNullOrEmpty(outputDir))
                    outputDir = global::System.Environment.GetEnvironmentVariable("VFX_OUTPUT_DIR") ?? outputDir;
