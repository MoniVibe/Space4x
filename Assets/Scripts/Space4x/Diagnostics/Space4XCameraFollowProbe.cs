...
namespace Space4X.Diagnostics
{
    ...
    public sealed class Space4XCameraFollowProbe : MonoBehaviour
    {
        ...
        private const string ProbeEchoEnv = "SPACE4X_CAMERA_PROBE_ECHO";
        ...
        private void OnEnable()
        {
            ...
            _lastCameraYaw = 0f;
            _lastSampleAt = 0f;
            UnityEngine.Debug.Log($"[Space4XCameraFollowProbe] boot active={_active} echo={echoToUnityLog} path='{_outputPath}'");
        }
        ...
        private static string ResolveOutputPath()
        {
            ...
            var outDir = global::System.Environment.GetEnvironmentVariable(ProbeOutDirEnv);
        ...
        {
            enabled = false;
            var env = global::System.Environment.GetEnvironmentVariable(key);
            if (string.IsNullOrWhiteSpace(env))
            {
                return false;
            }
