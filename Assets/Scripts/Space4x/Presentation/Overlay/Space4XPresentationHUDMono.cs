...
namespace Space4X.Presentation.Overlay
{
    ...
    public sealed class Space4XPresentationHUDMono : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (Space4XOverlayInput.GetKeyDown(_toggleHudKey))
            {
                _showHud = !_showHud;
            }
        ...
        private void RefreshSnapshot()
        {
            ...
            var envScenario = System.Environment.GetEnvironmentVariable(ScenarioPathEnv);
            ...
            snapshot.ResourceSourceCount = Count<PureDOTS.Runtime.Components.ResourceSourceState>(entityManager);
