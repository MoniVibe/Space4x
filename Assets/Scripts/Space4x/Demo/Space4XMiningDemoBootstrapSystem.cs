...
namespace Space4X.Demo
{
    ...
    /// Uses DemoRenderUtil.MakeRenderable() to match the working debug cube pattern.
    /// </summary>
    ...
    public partial struct Space4XMiningDemoBootstrapSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            // Use the same pattern as Space4XDebugCubeSpawnerSystem - DemoRenderUtil.MakeRenderable()
            // This handles all render component setup (RenderMeshArray, MaterialMeshInfo, RenderBounds, etc.)
