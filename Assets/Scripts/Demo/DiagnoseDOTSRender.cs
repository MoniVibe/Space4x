...
public class DiagnoseDOTSRender : MonoBehaviour
{
    ...
    void RunDiagnostics()
    {
        ...
        Debug.Log("=== DOTS Render Diagnostics ===");

        // 1. Debug Cube
        CheckEntity(em, typeof(DebugOrbitTag), "Debug Cube");

        // 2. Carrier (check for Carrier component, lifecycle system adds CarrierPresentationTag)
        CheckEntity(em, typeof(Carrier), "Carrier");

        // 3. Craft (check for MiningVessel component, lifecycle system adds CraftPresentationTag)
