...
public class CreateScenarioURP
{
    public static void Execute()
    {
        ...
        string assetPath = folderPath + "/ScenarioURP.asset";
        string rendererPath = folderPath + "/ScenarioURP_Renderer.asset";
        ...
        rendererData.name = "ScenarioURP_Renderer";
        ...
        Debug.Log("Created ScenarioURP asset.");
    }
}
#endif
