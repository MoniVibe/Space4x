...
public class ConfigureRenderCatalog
{
    ...
    public static void Configure()
    {
        ...
        var variants = new Space4XRenderCatalogDefinition.Variant[4];
        ...
        // Projectile (Quad tracer)
        {
            Mesh mesh = GetPrimitiveMesh(PrimitiveType.Quad);
            var bounds = mesh.bounds;

            variants[3] = new Space4XRenderCatalogDefinition.Variant
            {
                Name = "ProjectileTracer",
                Mesh = mesh,
                Material = material,
                BoundsCenter = bounds.center,
                BoundsExtents = bounds.extents,
                PresenterMask = PureDOTS.Rendering.RenderPresenterMask.Tracer,
                RenderLayer = 0,
                VisualKind = RenderVisualKind.Tracer,
                TracerWidth = 0.35f,
                TracerLength = 8f,
