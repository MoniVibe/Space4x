...
namespace PureDOTS.Tests
{
    public class HandInputFlowTests
    {
        ...
        public void SetUp()
        {
            ...
            _bootstrapHandle = _world.GetOrCreateSystem<HandBootstrapSystem>();
            _commandHandle = _world.GetOrCreateSystem<HandCommandProcessingSystem>();
            _hoverHandle = _world.GetOrCreateSystem<HandHoverSystem>();
            _interactionHandle = _world.GetOrCreateSystem<HandInteractionSystem>();
            _miracleHandle = _world.GetOrCreateSystem<HandMiracleSystem>();
            _miracleDecayHandle = _world.GetOrCreateSystem<HandMiracleDecaySystem>();
