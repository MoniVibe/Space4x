...
namespace PureDOTS.Tests
{
    public class ResourceRegistryTests
    {
        ...
        private SystemHandle _registrySystem;
        ...
        public void SetUp()
        {
            ...
            _registrySystem = _world.GetOrCreateSystem<ResourceRegistrySystem>();
        }
        ...
        public void Registry_Populates_With_ResourceSites()
        {
            ...
            _registrySystem.Update(_world.Unmanaged);

            Assert.IsTrue(_em.CreateEntityQuery(ComponentType.ReadOnly<ResourceRegistryTag>()).TryGetSingletonEntity<ResourceRegistryTag>(out var reg));
